...
type CategoryType = 'tasks' | 'membership' | 'projects';
...
const typeToCategory: Record<NotificationType, CategoryType> = {
  task_assigned: 'tasks',
  task_updated: 'tasks',
  task_completed: 'tasks',
  join_request: 'membership',
  join_request_approved: 'membership',
  join_request_denied: 'membership',
  member_added: 'membership',
  member_removed: 'membership',
  project_update: 'projects',
  deadline_reminder: 'projects',
  meeting_reminder: 'projects',
};
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        ...
        >
          ...
          {(Object.entries(categoryLabels) as [CategoryType, string][]).map(([value, label]) => (
