...
const notificationIcons: Record<NotificationType, string> = {
  ...
  task_due_soon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z',
  ...
  added_to_project: 'M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z',
  removed_from_project: 'M13 7a4 4 0 11-8 0 4 4 0 018 0zM9 14a6 6 0 00-6 6v1h12v-1a6 6 0 00-6-6zM21 12h-6',
  project_status_changed: 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15',
  file_uploaded: 'M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12',
  deadline_approaching: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z',
  meeting_approaching: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z',
};
...
const notificationColors: Record<NotificationType, string> = {
  ...
  join_approved: 'text-green-600',
  join_rejected: 'text-red-600',
  added_to_project: 'text-green-600',
  removed_from_project: 'text-gray-600',
  project_status_changed: 'text-purple-600',
  file_uploaded: 'text-blue-600',
  deadline_approaching: 'text-orange-600',
  meeting_approaching: 'text-blue-600',
};
